...
def main():
    ...
    with tf.Session() as sess:
        ...
        # scope = 'actor_global_'+GLOBAL_ASSIGNMENT
        scope = 'testing_actor_' + GLOBAL_ASSIGNMENT

        actor = a3c_gs.ActorNetwork(state_dim=[
                                    S_INFO, S_LEN], action_dim=A_DIM, learning_rate=ACTOR_LR_RATE, scope=scope, global_workers=None)
